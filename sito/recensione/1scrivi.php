...
<body link="#007fff" vlink="#007fff" alink="#007fff" class="cv">
	...
	<div id="main-wrapper">
		<h2>Lascia una recensione sul Cristo Velato</h2>
		<form action='1salva.php' method='post'>
			<div class="stelle">
			...
			<p>Torna al Cristo velato per leggere altre <a href="../pagine/pg1.php#recensioni">recensioni</a></p>
