...
<body link="#007fff" vlink="#007fff" alink="#007fff" class="p">
	...
	<div id="main-wrapper">
		<h2>Lascia una recensione sul Palazzo Reale</h2>
		<form action='3salva.php' method='post'>
			<div class="stelle">
			...
			<p>Torna al Palazzo Reale per leggere altre <a href="../pagine/pg3.php#recensioni">recensioni</a></p>
