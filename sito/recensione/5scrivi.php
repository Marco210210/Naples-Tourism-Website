...
<body link="#007fff" vlink="#007fff" alink="#007fff" class="ma">
	...
	<div id="main-wrapper">
		<h2>Lascia una recensione sul Museo archeologico nazionale di Napoli</h2>
		<form action='5salva.php' method='post'>
			<div class="stelle">
			...
			<p>Torna al Museo archeologico per leggere altre <a href="../pagine/pg5.php#recensioni">recensioni</a></p>
