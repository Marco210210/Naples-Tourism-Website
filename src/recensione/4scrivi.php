...
<body link="#007fff" vlink="#007fff" alink="#007fff" class="d">
	...
	<div id="main-wrapper">
		<h2>Lascia una recensione sul Duomo e il Tesoro di San Gennaro</h2>
		<form action='4salva.php' method='post'>
			<div class="stelle">
			...
			<p>Torna al Duomo di San Gennaro per leggere altre <a href="../pagine/pg4.php#recensioni">recensioni</a></p>
