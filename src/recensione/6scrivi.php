...
<body link="#007fff" vlink="#007fff" alink="#007fff" class="sc">
	...
	<div id="main-wrapper">
		<h2>Lascia una recensione sul Chiostro di Santa Chiara</h2>
		<form action='6salva.php' method='post'>
			<div class="stelle">
			...
			<p>Torna al Chiostro di Santa Chiara per leggere altre <a href="../pagine/pg6.php#recensioni">recensioni</a></p>
